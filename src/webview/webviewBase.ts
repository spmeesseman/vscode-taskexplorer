...
// 	}
//
// 	protected notify<T extends IpcNotificationType<any>>(type: T, params: IpcMessageParams<T>, completionId?: string): Promise<boolean>
// 	{
...
// 	{
// 		if (!this._panel || !this.isReady || !this.visible) return Promise.resolve(false);
//
