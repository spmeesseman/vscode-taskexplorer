...
{   //
    ...
    {   //
        ...
        npmCommandMin: 1600,
        refreshCommand: 275,
        refreshCommandNoChanges: 85,
        refreshTaskTypeCommand: 250,
        removeWorkspaceFolder: 170,
        runCommandMin: 680,
        taskCommand: 580,
