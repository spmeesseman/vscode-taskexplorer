...
{   //
    ...
    //
    slowTime: {
        addWorkspaceFolder: 6040,
        buildTreeNoTasks: 330,
        cache: {
            build: 750,
            buildCancel: 290,
            rebuild: 6100,
            rebuildCancel: 490,
            rebuildNoChanges: 1120,
        },
        ...
        tasks: {
            ...
            npmCommand: 12320,
            npmCommandPkg: 9860,
            npmInstallCommand: 13230
        },
        taskCount: {
            verify: 650,
            verifyByTree: 670,
            verifyFirstCall: 1040,
            verifyNpm: 2400, // internal vscode npm task provider is slower than shit wtf
            verifyWorkspace: 2600,
        },
        viewReport: 500
    },
    //
