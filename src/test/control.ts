...
{   //
    ...
    //
    slowTime: {
        addWorkspaceFolder: 9720,
        buildFileCache: 920,
        buildFileCacheCancel: 710,
        buildTreeNoTasks: 420,
        rebuildFileCache: 9500,
        rebuildFileCacheCancel: 1030,
        rebuildFileCacheNoChanges: 2070,
        cache: {
            build: 970,
            buildCancel: 790,
            rebuild: 9700,
            rebuildCancel: 1690,
            rebuildNoChanges: 2040,
        },
        ...
        config: {
            ...
            excludesEvent: 2020,
            excludeTasksEvent: 3075,
            globEvent: 1230,
            groupingEvent: 1135,
            pathToProgramsEvent: 705,
            showHideSpecialFolder: 340,
            showHideUserTasks: 1150,
            specialFolderEvent: 385,
            readEvent: 25,
            sortingEvent: 1040
        },
        excludeCommand: 1810,
        explorerViewStartup: 15000,
        fetchTasksCommand: 2280,
        fileCachePersist: 370,
        findTaskPosition: 615,
        ...
        fs: {
            ...
            deleteEvent: 1370,
            deleteEventTsc: 1865,
            deleteFolderEvent: 1480,
            modifyEvent: 985,
        },
        getTreeTasks: 215,
        getTreeTasksNpm: 620, // npm task provider is slower than shit on a turtle
        licenseManagerEnterKey: 845,
        licenseMgrOpenPage: 110,
        licenseMgrOpenPageWithDetail: 325,
        licenseManagerDownCheck: 655,
        licenseManagerLocalCheck: 1805,
        licenseManagerLocalStartServer: 1195,
        licenseManagerRemoteCheck: 2315,
        licenseManagerRemoteStartServer: 3625,
        min: 45,
        refreshCommand: 15105,
        refreshCommandNoChanges: 280,
        removeWorkspaceFolder: 7470,
        runCommand: 5970,
        runPauseCommand: 2045,
        runStopCommand: 2305,
        storageRead: 50,
        storageUpdate: 50,
        ...
        taskCount: {
            verify: 765,
            verifyByTree: 810,
            verifyFirstCall: 1300,
            verifyNpm: 3065, // internal vscode npm task provider is slower than shit wtf
            verifyWorkspace: 3290,
        },
        viewReport: 1650
    },
    //
