...
export const GLOB_GULP = "**/[Gg][Uu][Ll][Pp][Ff][Ii][Ll][Ee].{[Bb][Aa][Bb][Ee][Ll].,}{[Jj][Ss],[Tt][Ss],[Mm][Jj][Ss]}";
export const GLOB_GRADLE = "**/*.[Gg][Rr][Aa][Dd][Ll][Ee]";
export const GLOB_GRUNT = "**/[Gg][Rr][Uu][Nn][Tt][Ff][Ii][Ll][Ee].[Jj][Ss]";
export const GLOB_MAKEFILE = "**/[Mm]akefile";
...
export const GLOB_TYPESCRIPT = "**/tsconfig.json";
export const GLOB_VSCODE = "**/.vscode/tasks.json";
