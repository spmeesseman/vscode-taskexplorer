...
export class NpmScriptHoverProvider implements HoverProvider {
	...
	constructor(context: ExtensionContext) {
		context.subscriptions.push(commands.registerCommand('taskView.runScriptFromHover', this.runScriptFromHover, this));
		context.subscriptions.push(commands.registerCommand('taskView.debugScriptFromHover', this.debugScriptFromHover, this));
	}
